...
const days = [
  {
    ...
    sessions: [
      ...
      { h: "Session 2 -- Theme: Tales and Tellers", items: ["Topic 1: Agricultural Histories: Reading & Interpreting Images -- AIMA Panel Discussion (60 mins) by Dr. Peter Moser, Dr. Yves Seger, Dr. Debra Reid (HYBRID / ONLINE).", "Topic 2: Farmers on the Screen: audiovisual heritage, an overlooked gem for agricultural museums? -- Dr. Sven Lefèvre, Centre for Agrarian History, Belgium (ONLINE)."] },
      ...
      <div className="container">
        <div className="conference__header">
          <div className={`conference__display reveal${vis ? " visible" : ""}`}>
            ...
            <img src="/cima/CIMA_FINAL_LOGO.jpg" alt="CIMA 2023 logo" className="conference__logo" />
