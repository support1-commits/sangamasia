...
import { Wheat, Sprout, Shovel, Building2, MapPin, ArrowRight } from "lucide-react";
    ...
    <section className="museums" ref={ref}>
      <div className="container">
        <div className={`museums__header reveal${vis ? " visible" : ""}`}>
          <div className="tag-badge on-light">Member Museums</div>
        ...
        <div className={`museums__layout reveal reveal-delay-2${vis ? " visible" : ""}`}>
          ...
          <div className="museum-panel" key={active}>
            <div className="museum-panel__hero">
              ...
              <div className="museum-panel__location"><MapPin size={14} strokeWidth={2} /> {m.location} · {m.type}</div>
            </div>
            <div className="museum-panel__body">
              ...
              <a href="#" className="museum-panel__cta">Explore Museum <ArrowRight size={14} strokeWidth={2} /></a>
            </div>
          </div>
        </div>
      </div>
